    ...
    <tr>
        ...
        <td>
            <b>
             ...
             Изучение пользователей мобильного приложения в стартапе по продажам продуктов питания</a>
            </b>
        </td>
        <td>
         На основе данных использования мобильного приложения для продажи продуктов питания, проведено исследование действий пользователей в соотвествии с основными 
         принципами событийной аналитики. Построена воронка продаж, исследован путь пользователей до покупки. Проведен анализ результатов A/B-теста по изменению шрифтов в приложении - проведено сравнение 2-х контрольных групп между собой, в целях проверки корректности разделения трафика, и сравнение с тестовой группой. В целях проверки статистически значимых различий между группами сформулированы 4 пары гипотез и проверены по всем 5-ти событиям. На основе данной проверки сделан вывод об отсутствии влияния экспериментальных изменений на поведение пользователей.  
        </td>
        <td>
        <code>визуализация данных</code><br/>
